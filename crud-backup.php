...
php artisan crud:generate WhatWeOffer --fields="title#string; iconImage#string; bannerText#string; bannerImage#string; desctiption#text; status#boolean; slug#string;" --view-path=administrator --controller-namespace=administrator ---group=administrator --pk=id

php artisan crud:generate SeoContent --fields="pagetitle#string; description#text; keyword#string; misc#string; slugurl#string; h1title#string; canonical#string; h2title#string; h3title#string; image#string; imagealttext#string; content#string; pageId#integer; userId#integer; collegeId#integer; examId#integer;" --view-path=administrator --controller-namespace=administrator ---group=administrator --pk=id

php artisan crud:generate ExaminationType --fields="name#string; status#boolean; slug#string;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ApplicationAndExamStatus --fields="name#string; misc#string; status#boolean; slug#string;" --view-path=examination  --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ApplicationMode --fields="name#string; status#boolean; slug#string;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExaminationMode --fields="name#string; status#boolean; slug#string;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate EligibilityCriteria --fields="name#string; status#boolean; slug#string;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExaminationImportantLinks --fields="title#string; url#text; examinationDetailsId#integer;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExamSection --fields="name#string; title#string; iconImage#string; status#boolean; slug#string;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate TypeOfExamination --fields="sortname#string; name#string; status#boolean; slug#string;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExaminationDetails --fields="title#string; description#text; functionalarea_id#integer; courses_id#string; slug#string; applicationFrom#string; applicationTo#string; exminationDate#string; resultAnnounce#string; image#string; imagealttext#string; content#string; getMoreInfoLink#string; userId#integer; status#boolean; totalLikes#integer; totalViews#integer; totalApplicationClick#integer; examEligibilityCriteria#longtext;  examDates#longtext; mockTestDesc#longtext; admidCardDesc#longtext; admidCardInstructions#longtext; examResultDesc#longtext; examAnalysisDesc#longtext;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExamApplicationProcess --fields="modeofapplication#integer; modeofpayment#integer; desctiption#longtext; typeOfExaminations_id#integer; employee_id#integer;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExamApplicationFee --fields="category#string; quota#string; mode#integer; gender#integer; amount#string; typeOfExaminations_id#integer; employee_id#integer;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExamEligibility --fields="degreeId#integer; degreeName#integer; desctiption#longtext; typeOfExaminations_id#integer; employee_id#integer;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExamDates --fields="degreeId#integer; degreeName#integer; eventName#text; eventDate#text; eventStatus#string; typeOfExaminations_id#integer; employee_id#integer;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExamSyllabusPaper --fields="degreeId#integer; degreeName#integer; paperName#string; totalMark#text; desctiption#longtext; typeOfExaminations_id#integer; employee_id#integer;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExamSyllabusPaperMarks --fields="degreeId#integer; degreeName#integer; unitName#string; topicname#Text; topicDesc#longtext; examSyllabusPaperId#integer; typeOfExaminations_id#integer; employee_id#integer;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExamPattern --fields="degreeId#integer; degreeName#integer; modeOfExam#integer; examDuration#string; totalQuestion#integer; totalMarks#integer; section#string; markingSchem#text; languageofpaper#string;  typeOfExaminations_id#integer; employee_id#integer;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExamAdmitCard --fields="degreeId#integer; degreeName#integer; description#longtext; rebemberPoints#text; typeOfExaminations_id#integer; employee_id#integer;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExamResult --fields="degreeId#integer; degreeName#integer; description#longtext; typeOfExaminations_id#integer; employee_id#integer;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExamCutOffs --fields="degreeId#integer; degreeName#integer; description#longtext; typeOfExaminations_id#integer; employee_id#integer;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id
...
php artisan crud:generate ExamCounsellingContacts --fields="degreeId#integer; degreeName#integer; contactPersonName#string; contactNumber#string; examCounsellingId#integer; typeOfExaminations_id#integer; employee_id#integer;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExamPreprationTips --fields="degreeId#integer; degreeName#integer; description#longtext; booksName#text; importantTopics#text; typeOfExaminations_id#integer; employee_id#integer;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExamAnalysisRecords --fields="degreeId#integer; degreeName#integer; description#longtext; papername#text; files#text; typeOfExaminations_id#integer; employee_id#integer;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExamAnswerKey --fields="degreeId#integer; degreeName#integer; description#longtext; importantDesc#longtext; papername#text; typeOfExaminations_id#integer; employee_id#integer;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExamAnswerKeyEvent --fields="degreeId#integer; degreeName#integer; paperName#string; dates#string;  files#string; links#string; examAnswerKeyID#integer; typeOfExaminations_id#integer; employee_id#integer;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExamFaq --fields="question#text; answe#longtext; refLinks#string; typeOfExaminations_id#integer; employee_id#integer;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExamQuestion --fields="questionDate#datetime; question#text; userId#integer; typeOfExaminations_id#integer; employee_id#integer;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExamQuestionAnswer --fields="answerDate#datetime; answer#text; questionId#integer; userId#integer; typeOfExaminations_id#integer; employee_id#integer; likes#integer; share#integer;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id

php artisan crud:generate ExamQuestionAnswerComment --fields="answerDate#datetime; replyanswer#text; answerId#integer; questionId#integer; userId#integer; typeOfExaminations_id#integer; employee_id#integer; likes#integer; share#integer;" --view-path=examination --controller-namespace=examination ---group=examination --pk=id


php artisan crud:generate CounselingBoards --fields="title#string; status#boolean; slug#string;" --view-path=counseling --controller-namespace=counseling ---group=counseling --pk=id

php artisan crud:generate CounselingBoardDetails --fields="title#string; description#text; image#string; aboutBoard#longtext; admissionDesc#longtext; boardDesc#longtext; syllabusDesc#longtext; samplePaper#longtext; admitCardDetails#longtext; preprationTips#longtext; resultDesc#longtext; entranceExam#longtext; chooseRightCollege#longtext; counselingBoardId#integer;" --view-path=counseling --controller-namespace=counseling ---group=counseling --pk=id

php artisan crud:generate CounselingBoardImpDates --fields="dates#string; description#text; counselingBoardId#integer;" --view-path=counseling --controller-namespace=counseling ---group=counseling --pk=id

php artisan crud:generate CounselingBoardLatestUpdates --fields="dates#string; description#text; counselingBoardId#integer;" --view-path=counseling --controller-namespace=counseling ---group=counseling --pk=id

php artisan crud:generate CounselingBoardHighlights --fields="title#string; description#text; counselingBoardId#integer;" --view-path=counseling --controller-namespace=counseling ---group=counseling --pk=id

php artisan crud:generate CounselingBoardExamDates --fields="class#string; dates#string; subject#string; setting#string;  counselingBoardId#integer;" --view-path=counseling --controller-namespace=counseling ---group=counseling --pk=id

php artisan crud:generate CounselingBoardSamplePapers --fields="class#string; subject#string; description#text; counselingBoardId#integer;" --view-path=counseling --controller-namespace=counseling ---group=counseling --pk=id

php artisan crud:generate CounselingBoardSyllabus --fields="class#string; subject#string; description#text; counselingBoardId#integer;" --view-path=counseling --controller-namespace=counseling ---group=counseling --pk=id

php artisan crud:generate CounselingBoardAdmissionDates --fields="place#string; dates#string; fees#string; class#string; subjects#string; counselingBoardId#integer;" --view-path=counseling --controller-namespace=counseling ---group=counseling --pk=id

php artisan crud:generate CounselingCareerInterests --fields="title#string; description#text; image#string; status#boolean; functionalarea_id#integer; slug#string;" --view-path=counseling --controller-namespace=counseling ---group=counseling --pk=id
...
php artisan crud:generate CounselingCareerSkillRequirement --fields="title#string; careerDetailsId#integer;" --view-path=counseling --controller-namespace=counseling ---group=counseling --pk=id

php artisan crud:generate CounselingCareerWhereToStudy --fields="instituteName#string; instituteUrl#string; city#string; programmeFees#string; careerDetailsId#integer;" --view-path=counseling --controller-namespace=counseling ---group=counseling --pk=id

php artisan crud:generate CounselingCareerJobRoleSalery --fields="title#string; avgSalery#string; topCompany#text;careerDetailsId#integer;" --view-path=counseling --controller-namespace=counseling ---group=counseling --pk=id
...
php artisan crud:generate CounselingCoursesEducationLevel --fields="educationlevel_id#integer; functionalarea_id#integer; coursesDetailsId#integer; educationLevelSlug#string;" --view-path=counseling --controller-namespace=counseling ---group=counseling --pk=id

php artisan crud:generate CounselingCoursesJobCareer --fields="courseName#string; jobProfiles#string; avgSalery#string; topCompany#text; coursesDetailsId#integer;" --view-path=counseling --controller-namespace=counseling ---group=counseling --pk=id

php artisan crud:generate CounselingCoursesMoreTitles --fields="title#string; coursesDetailsId#integer;" --view-path=counseling --controller-namespace=counseling ---group=counseling --pk=id
...
php artisan crud:generate CounselingCareerJobRoleSalaery --fields="title#string; avgSalery#string; topCompany#text;careerDetailsId#integer;" --view-path=counseling --controller-namespace=counseling ---group=counseling --pk=id
...
php artisan crud:generate CounselingCoursesDetails --fields="title#string; description#text; image#string; bestChoiceOfCourse#longtext; jobsCareerOpportunityDesc; slug#string; educationlevel_id#integer; functionalarea_id#integer;" --view-path=counseling --controller-namespace=counseling ---group=counseling --pk=id
...
php artisan crud:generate SliderManager --fields="slidetTitle#string; bottomText#string; sliderImage#string; bottomLink#text; status#boolean; isShowCollegeCount#boolean; isShowExamCount#boolean; isShowCourseCount#boolean; isShowBlogCount#boolean; scrollerFirstText#string; scrollerLastText#string;" --view-path=administrator --controller-namespace=administrator ---group=administrator --pk=id

php artisan crud:generate LatestUpdate --fields="name#string; date#string; desc#text; status#boolean; users_id#integer; employee_id#integer;" --view-path=administrator --controller-namespace=administrator ---group=administrator --pk=id

php artisan crud:generate AskQuestion --fields="question#text; questionDate#datetime; userId#integer; status#boolean; employee_id#integer;" --view-path=administrator --controller-namespace=administrator ---group=administrator --pk=id

php artisan crud:generate AskQuestionAnswer --fields="answer#text; answerDate#datetime; questionId#integer; userId#integer; employee_id#integer; status#boolean; likes#integer; share#integer;" --view-path=administrator --controller-namespace=administrator ---group=administrator --pk=id

php artisan crud:generate AskQuestionAnswerComment --fields="replyanswer#text; answerDate#datetime; answerId#integer; questionId#integer; userId#integer; employee_id#integer; status#boolean; likes#integer; share#integer;" --view-path=administrator --controller-namespace=administrator ---group=administrator --pk=id

php artisan crud:generate AskQuestionTags --fields="name#string; slug#string;" --view-path=administrator --controller-namespace=administrator ---group=administrator --pk=id

php artisan crud:generate CollegeManagementDetails --fields="name#string; designation#string; gender#integer; picture#string; emailaddress#string; phoneno#string; landlineNo#string; about#text; users_id#integer; collegeprofile_id#integer; employee_id#integer;" --view-path=administrator --controller-namespace=administrator ---group=administrator --pk=id

php artisan crud:generate CollegeScholarship --fields="title#string; description#text; users_id#integer; collegeprofile_id#integer; employee_id#integer;" --view-path=administrator --controller-namespace=administrator ---group=administrator --pk=id

php artisan crud:generate CollegeSocialMediaLinks --fields="title#string; url#text; isActive#boolean; other#string; users_id#integer; collegeprofile_id#integer; employee_id#integer;" --view-path=administrator --controller-namespace=administrator ---group=administrator --pk=id

php artisan crud:generate CollegeCutOffs --fields="title#string; description#text; functionalarea_id#integer; degree_id#integer; coursetype_id#integer; course_id#integer; users_id#integer; collegeprofile_id#integer; employee_id#integer;" --view-path=administrator --controller-namespace=administrator ---group=administrator --pk=id

php artisan crud:generate CollegeReviews --fields="title#string; description#text; votes#integer; academic#integer; accommodation#integer; faculty#integer; infrastructure#integer; placement#integer; social#integer; guestUserId#integer; users_id#integer; collegeprofile_id#integer; employee_id#integer;" --view-path=administrator --controller-namespace=administrator ---group=administrator --pk=id

php artisan crud:generate FacultyExperience --fields="fromyear#integer; toyear#integer; role#string; organisation#string; city#string; users_id#integer; collegeprofile_id#integer; employee_id#integer;" --view-path=administrator --controller-namespace=administrator ---group=administrator

php artisan crud:generate FacultyQualification --fields="qualification#string; course#string; sunjects#string; collegename#string; boardName#string; year#integer; users_id#integer; collegeprofile_id#integer; employee_id#integer;" --view-path=administrator --controller-namespace=administrator ---group=administrator

php artisan crud:generate CollegeFaqs --fields="question#text; answer#longtext; refLinks#string; users_id#integer; collegeprofile_id#integer; employee_id#integer;" --view-path=administrator --controller-namespace=administrator ---group=administrator --pk=id

php artisan crud:generate CollegeSportsActivity --fields="typeOfActivity#text; name#longtext; users_id#integer; collegeprofile_id#integer; employee_id#integer;" --view-path=administrator --controller-namespace=administrator ---group=administrator --pk=id

php artisan crud:generate FacultyDepartment --fields="functionalarea_id#integer; educationlevel_id#integer; degree_id#integer; coursetype_id#integer; course_id#integer; faculty_id#integer; users_id#integer; collegeprofile_id#integer; employee_id#integer;" --view-path=administrator --controller-namespace=administrator ---group=administrator --pk=id
...
php artisan crud:generate CollegeAdmissionImportantDated --fields="fromdate#string; todate#string; eventName#text; collegeAdmissionProcedure_id#integer; users_id#integer; collegeprofile_id#integer; employee_id#integer;" --view-path=administrator --controller-namespace=administrator ---group=administrator --pk=id

php artisan crud:generate ExamCounsellingForm --fields="name#string; email#string; phone#string; city_id#integer; course_id#integer; exam_id#integer; users_id#integer; employee_id#integer;" --view-path=administrator --controller-namespace=administrator ---group=administrator --pk=id

php artisan crud:generate RequestForCreateCollegeAccount --fields="collegeName#string; email#string; phone#string; contactPersonName#string; employee_id#integer;" --view-path=administrator --controller-namespace=administrator ---group=administrator --pk=id

php artisan crud:generate LandingPageQueryForm --fields="fullname#string; mobilenumber#string; emailaddress#string; subject#string; message#text; users_id#integer; employee_id#integer;" --view-path=administrator --controller-namespace=administrator ---group=administrator --pk=id
